...
public class ImageMarkLogoUtil {
    ...
    public static void markImageByIcon(String iconPath, String srcImgPath, String targerPath, Integer degree) {
        ...
        try {
            ...
            // 6、水印图片的位置
            g.drawImage(img, srcImg.getWidth(null)-imgIcon.getIconWidth(), srcImg.getHeight(null)-imgIcon.getIconHeight(), null);
    ...
    public static void main(String [] args){
        String srcImgPath = "c:/1.jpg";  
        String iconPath = "c:/2.png";  
        String targerIconPath = "c:/3.jpg";  
